...
/**
 * 清除内外缓存、清除数据库、清除sharedPreferences,清除files和自定义目录
 * @author: swolf
...
public class DataCleanManager {
    ...
    /**
     * 清除/data/data/com.xx.xx/files下的内容
     * @param context
     */
    ...
    //删除方法，只删除某个文件下的文件，如果传入的directory是个文件，将不做处理
    ...
    public static String getFormatSize(double size) {
        ...
        BigDecimal result3 = new BigDecimal(tereByte);
        return result3.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString() + "TB";
    }
