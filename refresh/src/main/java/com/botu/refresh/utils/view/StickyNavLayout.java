package com.botu.refresh.utils.view;
...
import com.botu.refresh.utils.RefreshScrollingUtils;
...
public class StickyNavLayout extends LinearLayout {
    ...
    public StickyNavLayout mRefreshLayout;
    ...
    public boolean isContentViewToTop() {
        ...
        if (RefreshScrollingUtils.isScrollViewOrWebViewToTop(mDirectWebView)) {
            return true;
        }

        if (RefreshScrollingUtils.isScrollViewOrWebViewToTop(mDirectScrollView)) {
            return true;
        }

        if (RefreshScrollingUtils.isAbsListViewToTop(mDirectAbsListView)) {
            return true;
        }

        if (RefreshScrollingUtils.isRecyclerViewToTop(mDirectRecyclerView)) {
            return true;
        }
    ...
    private boolean isViewPagerContentViewToTop() {
        ...
        if (RefreshScrollingUtils.isScrollViewOrWebViewToTop(mNestedWebView)) {
            return true;
        }

        if (RefreshScrollingUtils.isScrollViewOrWebViewToTop(mNestedScrollView)) {
            return true;
        }

        if (RefreshScrollingUtils.isAbsListViewToTop(mNestedAbsListView)) {
            return true;
        }

        if (RefreshScrollingUtils.isRecyclerViewToTop(mNestedRecyclerView)) {
            return true;
        }
    ...
    public void setRefreshLayout(StickyNavLayout refreshLayout) {
    ...
    public boolean shouldHandleLoadingMore() {
        ...
        if (RefreshScrollingUtils.isWebViewToBottom(mDirectWebView)) {
            return true;
        }

        if (RefreshScrollingUtils.isScrollViewToBottom(mDirectScrollView)) {
            return true;
        }
        ...
        if (mDirectViewPager != null) {
            ...
            if (RefreshScrollingUtils.isWebViewToBottom(mNestedWebView)) {
                return true;
            }

            if (RefreshScrollingUtils.isScrollViewToBottom(mNestedScrollView)) {
                return true;
            }
    ...
    public void scrollToBottom() {
        RefreshScrollingUtils.scrollToBottom(mDirectScrollView);
        RefreshScrollingUtils.scrollToBottom(mDirectRecyclerView);
        RefreshScrollingUtils.scrollToBottom(mDirectAbsListView);

        if (mDirectViewPager != null) {
            if (mNestedContentView == null) {
                regetNestedContentView();
            }
            RefreshScrollingUtils.scrollToBottom(mNestedScrollView);
            RefreshScrollingUtils.scrollToBottom(mNestedRecyclerView);
            RefreshScrollingUtils.scrollToBottom(mNestedAbsListView);
        }
    }
}