package com.botu.refresh.utils.activity;
...
import com.botu.img.ui.view.StickyNavLayout;

import java.lang.reflect.Field;

public class RefreshScrollingUtils {

    private RefreshScrollingUtils() {
    }
    ...
    public static boolean isAbsListViewToBottom(AbsListView absListView) {
        if (absListView != null && absListView.getAdapter() != null && absListView.getChildCount() > 0 && absListView.getLastVisiblePosition() == absListView.getAdapter().getCount() - 1) {
            ...
            if (stickyNavLayout != null) {
                // 处理StickyNavLayout中lastChild.getBottom() <= absListView.getMeasuredHeight()失效问题
        ...
        if (recyclerView != null) {
            ...
            if (manager instanceof LinearLayoutManager) {
                ...
                if (layoutManager.findLastCompletelyVisibleItemPosition() == layoutManager.getItemCount() - 1) {
                    ...
                    if (stickyNavLayout != null) {
                        // 处理StickyNavLayout中findLastCompletelyVisibleItemPosition失效问题
