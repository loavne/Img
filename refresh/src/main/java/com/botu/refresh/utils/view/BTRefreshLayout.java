 ...
 */
public class BTRefreshLayout extends LinearLayout {
    private static final String TAG = BTRefreshLayout.class.getSimpleName();
     ...
     * 下拉刷新和上拉加载更多代理
     */
    private BTRefreshLayoutDelegate mDelegate;
    /**
     * 手指按下时，y轴方向的偏移量
     */
    ...
    public BTRefreshLayout(Context context) {
        this(context, null);
    }

    public BTRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onFinishInflate() {
        ...
        if (getChildCount() != 2) {
            throw new RuntimeException(BTRefreshLayout.class.getSimpleName() + "必须有且只有一个子控件");
        }
    ...
    /**
     * 切换到正在刷新状态，会调用delegate的onBTRefreshLayoutBeginRefreshing方法
     */
    public void beginRefreshing() {
        if (mCurrentRefreshStatus != RefreshStatus.REFRESHING && mDelegate != null) {
            ...
            handleRefreshStatusChanged();
            mDelegate.onBTRefreshLayoutBeginRefreshing(this);
        }
    }
    ...
    /**
     * 开始上拉加载更多，会触发delegate的onBTRefreshLayoutBeginRefreshing方法
     */
    public void beginLoadingMore() {
        if (!mIsLoadingMore && mLoadMoreFooterView != null && mDelegate != null && mDelegate.onBTRefreshLayoutBeginLoadingMore(this)) {
            mIsLoadingMore = true;
     ...
     * @param delegate
     */
    public void setDelegate(BTRefreshLayoutDelegate delegate) {
        mDelegate = delegate;
    }
    ...
    public interface BTRefreshLayoutDelegate {
        /**
         * 开始刷新
         */
        void onBTRefreshLayoutBeginRefreshing(BTRefreshLayout refreshLayout);
         ...
         */
        boolean onBTRefreshLayoutBeginLoadingMore(BTRefreshLayout refreshLayout);
    }
