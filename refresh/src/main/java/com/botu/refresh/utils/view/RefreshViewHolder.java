...
public abstract class RefreshViewHolder {
     ...
     * 下拉刷新上拉加载更多控件
     */
    protected BTRefreshLayout mBTRefreshLayout;
    /**
     * 下拉刷新控件
     */
    ...
    public void startChangeWholeHeaderViewPaddingTop(int distance) {
        mBTRefreshLayout.startChangeWholeHeaderViewPaddingTop(distance);
    }

    /**
     * 设置下拉刷新上拉加载更多控件，该方法是设置BGARefreshViewHolder给BTRefreshLayout时由BTRefreshLayout调用
     *
     * @param BTRefreshLayout
     */
    public void setBTRefreshLayout(BTRefreshLayout BTRefreshLayout) {
        mBTRefreshLayout = BTRefreshLayout;
    }
